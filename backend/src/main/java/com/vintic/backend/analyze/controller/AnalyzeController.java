...
public class AnalyzeController {
    ...
    public ResponseEntity<ApiResponse<AnalyzeResponse>> analyzeImage(@RequestPart("images") List<MultipartFile> images) {
        // 에러나면 서비스가 알아서 던지고 Advice가 알아서 처리함
        AnalyzeResponse aiAnalysisResult = productAnalyzeService.processImageAndAnalyze(images);
